 ...
 * name to be "client". This sets onus on the Flink cluster administrator to configure/provide right
...
public class JaasConfiguration extends Configuration {
	...
	static {
		...
		String enableDebug = System.getenv("FLINK_JAAS_DEBUG");
		if(enableDebug != null && "true".equalsIgnoreCase(enableDebug)) {
